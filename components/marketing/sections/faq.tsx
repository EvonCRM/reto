...
const DATA = [
  {
    ...
    answer: `This is a demo application built with FormBuilder. It will save you time and effort building your next SaaS. Here you would write something like "${AppInfo.APP_NAME} helps you manage customer relationships, organize sales activities and improve service delivery to make your business more efficient and successful."`
  },
  {
